...
part1 = csvread('datasets/slng/total_training_slng_scores_part1_Matlab.csv');
part2 = csvread('datasets/slng/total_training_slng_scores_part2_Matlab.csv');
part3 = csvread('datasets/slng/total_training_slng_scores_part3_Matlab.csv');
part4 = csvread('datasets/slng/total_training_slng_scores_part4_Matlab.csv');
part5 = csvread('datasets/slng/total_training_slng_scores_part5_Matlab.csv');
...
T = [2100:500:5000];%[10,20,50,100,500,1000,2000];

fileid = fopen('model/slng/errors.txt','w');
...
clear y
save 'model/slng/adamodel.mat' finalmodel;
...
benchmark = csvread('datasets/slng/TM2_slng_scores_Matlab.csv');
bX = benchmark(:,1:d);
bY = benchmark(:,d+1);
bY = 2*bY - 1;
