...
part1 = csvread('datasets/cs_slng_physco/total_training_cs_slng_physco_1_Matlab.csv');
part2 = csvread('datasets/cs_slng_physco/total_training_cs_slng_physco_2_Matlab.csv');
part3 = csvread('datasets/cs_slng_physco/total_training_cs_slng_physco_3_Matlab.csv');
part4 = csvread('datasets/cs_slng_physco/total_training_cs_slng_physco_4_Matlab.csv');
part5 = csvread('datasets/cs_slng_physco/total_training_cs_slng_physco_5_Matlab.csv');
...
fileid = fopen('model/cs_slng_physco/errors.txt','w');
...
data = csvread('datasets/cs_slng_physco/total_training_cs_slng_physco_Matlab.csv');
...
clear y
save 'model/cs_slng_physco/adamodel.mat' finalmodel;
...
benchmark = csvread('datasets/cs_slng_physco/TM2_cs_slng_physco_Matlab.csv');
bX = benchmark(:,1:d);
bY = benchmark(:,d+1);
bY = 2*bY - 1;
