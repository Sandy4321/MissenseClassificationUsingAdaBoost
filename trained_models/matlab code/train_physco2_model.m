...
part1 = csvread('datasets/physco2/total_training_physco2_1_Matlab.csv');
part2 = csvread('datasets/physco2/total_training_physco2_2_Matlab.csv');
part3 = csvread('datasets/physco2/total_training_physco2_3_Matlab.csv');
part4 = csvread('datasets/physco2/total_training_physco2_4_Matlab.csv');
part5 = csvread('datasets/physco2/total_training_physco2_5_Matlab.csv');
...
T = [10,20,50,100,300,500,700,900,1000,2000,3000,5000,10000,20000];

fileid = fopen('model/physco2/20000/errors.txt','w');
...
data = csvread('datasets/physco2/total_training_physco2_Matlab.csv');
...
clear y
save 'model/physco2/20000/adamodel.mat' finalmodel;
...
benchmark = csvread('datasets/physco2/TM_physco2_Matlab.csv');
bX = benchmark(:,1:d);
bY = benchmark(:,d+1);
bY = 2*bY - 1;
