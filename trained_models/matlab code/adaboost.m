function [estimateclasstotal,confidence,model]=adaboost(mode,datafeatures,dataclass_or_model,itt)
...
% The boosting part calls the classifier iteratively, after every classification
