...
part1 = csvread('datasets/cs/total_training_cs_win_numseqs_1_Matlab.csv');
part2 = csvread('datasets/cs/total_training_cs_win_numseqs_2_Matlab.csv');
part3 = csvread('datasets/cs/total_training_cs_win_numseqs_3_Matlab.csv');
part4 = csvread('datasets/cs/total_training_cs_win_numseqs_4_Matlab.csv');
part5 = csvread('datasets/cs/total_training_cs_win_numseqs_5_Matlab.csv');
...
T = [10,20,50,100,500,1000,5000,10000,20000];

fileid = fopen('model/cs/20000/errors.txt','w');
...
data = csvread('datasets/cs/total_training_cs_win_numseqs_Matlab.csv');
...
clear y
save 'model/cs/20000/adamodel.mat' finalmodel;
...
benchmark = csvread('datasets/cs/TM_conserv_scores_with_window_numseqs_Matlab.csv');
bX = benchmark(:,1:d);
bY = benchmark(:,d+1);
bY = 2*bY - 1;
